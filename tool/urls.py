...
urlpatterns = [
    ...
    path("app/terms/", views.standalone_terms, name="standalone_terms"),
    path("app/privacy/", views.standalone_privacy, name="standalone_privacy"),
    ...
    path("app/assignments/<slug:slug>/view-as-student/", views.standalone_view_as_student, name="standalone_view_as_student"),
    path("app/assignments/<slug:slug>/exit-student-view/", views.standalone_exit_student_view, name="standalone_exit_student_view"),
    ...
    path("viva/mcq/", views.viva_mcq, name="viva_mcq"),
    path("viva/mcq/answer/", views.viva_mcq_answer, name="viva_mcq_answer"),
